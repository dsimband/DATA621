...
There are several columns with null values and only 191 complete records out of 2276 totoal records.

```{r}

sk_df %>% dplyr:: filter(n_missing > 0 ) %>% dplyr::select(skim_variable,n_missing)
